      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          >
            ...
            <ul className="space-y-2">
              <li>
                <span
                  onClick={() =>
                    openModal(
                      "Terms & Conditions",
                      "Dummy text for Terms & Conditions."
                    )
                  }
                  className="cursor-pointer font-poppins text-sm text-gray-300 transition-colors hover:text-gold"
                >
                  Terms & Conditions
                </span>
              </li>
              ...
              <li>
                <span
                  onClick={() =>
                    openModal("Refund Policy", "Dummy text for Refund Policy.")
                  }
                  className="cursor-pointer font-poppins text-sm text-gray-300 transition-colors hover:text-gold"
                >
                  Refund Policy
                ...
                <span
                  onClick={() =>
                    openModal(
                      ...
                      "Dummy text for Pricing & Deliverables."
                    )
                  }
                  className="cursor-pointer font-poppins text-sm text-gray-300 transition-colors hover:text-gold"
                >
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="font-poppins text-sm text-gray-300">
                Email: info@heroesofhyderabad.com
              </li>
              <li className="font-poppins text-sm text-gray-300">
        ...
        >
          <p className="font-poppins text-sm text-gray-400">
            © {currentYear} Heroes of Hyderabad. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
